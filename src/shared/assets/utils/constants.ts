export const newsArray = [
    ...
    },
    {
        ...
        // eslint-disable-next-line max-len
        newsText: `💙Пост от нашего болельщика Тимофея Усольцева: "Моё любимое время года-время,когда сбываются мечты!🌲💫🌏 Долгожданная встреча с кумиром-10.12.2023г.!🏀"
...
export const playersNumbersList: Record<number, string> = {
    59388: '16',
    264683: '33',
    15825: '12',
    80767: '7',
